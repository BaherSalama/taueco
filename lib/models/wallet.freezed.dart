...
abstract class $WalletCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String name, String code, String? user});
}
...
class _$WalletImpl implements _Wallet {
  _$WalletImpl({this.id, required this.name, required this.code, this.user});
  ...
  @override
  String toString() {
    return 'Wallet(id: $id, name: $name, code: $code, user: $user)';
  }
...
abstract class _Wallet implements Wallet {
  factory _Wallet(
      ...
      final String? user}) = _$WalletImpl;
